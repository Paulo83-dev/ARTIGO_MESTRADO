...
| :--- | :--- | :--- | :--- | :--- |
| **01. Extração & Chunking** | [`modulos/etapa1_extracao/`](file:///c:/Users/paulo/OneDrive/%C3%81rea%20de%20Trabalho/Cursos%20e%20Educa%C3%A7%C3%A3o/ARTIGO%20MESTRADO/modulos/etapa1_extracao/) | Ingestão e OCR inteligente via Docling (CUDA/CPU), reconstrução de tabelas (TableFormer) e *Layout-Aware Chunking* (HybridChunker) | Arquivos `.pdf` | `<doc>.md`, `chunks.json` e `indice_chunks_consolidado.json` |
